...
SCAM_TEMPLATES = {
    ...
    "bank_fraud": [
        "Your SBI account has been compromised. Verify OTP immediately or funds will be lost.",
        "HDFC Bank alert: Suspicious transaction of Rs 49999 detected. Call +91-9876543210 to block.",
        "Dear customer, your account 3344556677889900 has unauthorized access. Transfer funds to safe account.",
        "ICICI Bank: Your debit card ending 4567 used at unknown location. Share OTP to block.",
        "Aapke account se 25000 kat gaye hain. Turant call karein +91-8899776655.",
        "Bank of India security alert: Account frozen due to KYC mismatch. Update at {link}.",
        "Axis Bank: Transaction of Rs 15000 pending. If not done by you, share OTP to cancel.",
        "Your PNB account under investigation. Transfer balance to RBI safe account 1122334455667788.",
        "SBI se bol rahe hain. Aapke account mein fraud hua hai. Safe account pe transfer karein.",
        "Canara Bank alert: Your net banking will be blocked. Verify at {link} within 2 hours.",
        "URGENT: Your savings account debited Rs 35000. Call our helpline +91-7766554433 immediately.",
        "Federal Bank: Credit card blocked due to suspicious activity. Unblock at {link}.",
    ],
    "upi_fraud": [
        "Pay Rs 1 to verify your UPI ID. Send to verify@ybl for activation.",
        "Google Pay cashback of Rs 500! Send Rs 10 to cashback.offer@paytm to claim.",
        "PhonePe lucky draw winner! Send Rs 100 to winner.claim@oksbi to receive Rs 50000.",
        "UPI refund pending. Pay Rs 5 processing fee to refund@okaxis to receive Rs 2000.",
        "Bhai Rs 1 bhejo mere@ybl pe, testing kar raha hun naya UPI.",
        "OLX buyer here. Scan this QR or pay to buyer.verify@paytm to confirm order.",
        "BHIM UPI reward: Send Rs 50 to rewards@ybl and get Rs 500 cashback instantly.",
        "Your Google Pay account needs verification. Pay Rs 1 to support.gpay@oksbi.",
        "Aapka PhonePe reward ready hai. Rs 25 bhejo claim@paytm pe, Rs 1000 milega.",
        "Amazon Pay offer: Send to deals@okaxis. Get 10x cashback on your transaction.",
        "UPI se payment failed? Pay Rs 10 to retry@ybl for instant retry.",
        "Paytm verification pending. Complete by sending Rs 1 to verify.account@paytm.",
    ],
    "phishing": [
        "Click http://sbi-secure-login.fake.xyz/verify to update your banking credentials now.",
        "Your Amazon account will be suspended. Verify at http://amazon-verify.scam.com/login.",
        "IRCTC booking failed. Retry at http://irctc-booking.fake.in/retry?ref=12345.",
        "Flipkart order cancelled. Claim refund at http://flipkart-refund.scam.xyz/claim.",
        "SBI YONO login expired. Reactivate at http://sbi-yono.fake.com/activate immediately.",
        "Your email storage full. Upgrade free at http://gmail-storage.fake.xyz/upgrade.",
        "PAN-Aadhaar linking deadline extended. Link now at http://pan-aadhaar.fake.in/link.",
        "Income tax e-filing portal updated. Login at http://efiling-it.fake.com/portal.",
        "Aapka Paytm KYC expire ho gaya. Update karein: http://paytm-kyc.fake.xyz/update.",
        "EPFO claim ready. Download form at http://epfo-claim.fake.in/download.",
        "WhatsApp Gold exclusive version! Download: http://whatsapp-gold.fake.com/install.",
        "Government scheme benefit Rs 6000. Apply: http://pm-scheme.fake.in/apply?aadhaar=true.",
    ],
}
