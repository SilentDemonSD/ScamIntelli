...
name: 'Prompt Builder'
tools: ['search/codebase', 'edit/editFiles', 'web/fetch', 'web/githubRepo', 'read/problems', 'execute/runInTerminal', 'search', 'search/searchResults', 'read/terminalLastCommand', 'read/terminalSelection', 'search/usages', 'microsoftdocs/mcp/*']
---
...
- agent task --prompt-file .github/prompts/coding-standards.prompt.md inside the prompt to follow best practices 
